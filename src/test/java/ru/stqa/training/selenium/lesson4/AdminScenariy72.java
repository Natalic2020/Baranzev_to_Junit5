...
public class AdminScenariy72 extends TestBaseChrome {
    ...
    public  void MenuLeftTest() {
        loginAdmin();
        wait.until((WebDriver driver) -> driver.findElements(By.id("box-apps-menu")));
        ...
        wait.until((WebDriver driver) -> driver.findElement(By.xpath("//span[contains(.,'Appearence')]")));
        assertTrue(areElementsPresent(By.xpath("//span[contains(.,'Appearence')]")));
